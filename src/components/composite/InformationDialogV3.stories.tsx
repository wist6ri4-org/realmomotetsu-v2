...
import InformationDialogV3 from "./InformationDialogV3";
 ...
 */
const meta = {
    title: "Composite/InformationDialogV3",
    component: InformationDialogV3,
    tags: ["autodocs"],
    args: {
        teamData,
    },
} satisfies Meta<typeof InformationDialogV3>;
