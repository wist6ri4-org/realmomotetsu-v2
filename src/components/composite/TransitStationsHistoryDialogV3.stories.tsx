...
import TransitStationsHistoryDialogV3 from "./TransitStationsHistoryDialogV3";
...
const meta = {
    title: "Composite/TransitStationsHistoryDialogV3",
    component: TransitStationsHistoryDialogV3,
    tags: ["autodocs"],
...
} satisfies Meta<typeof TransitStationsHistoryDialogV3>;
...
export const NoHistory: Story = {
    ...
    play: async ({ canvasElement }) => {
        const canvas = within(canvasElement);
        await userEvent.click(canvas.getByRole("button", { name: "ダイアログを開く" }));
        await expect(within(document.body).getByText("0回ゴール / 0駅通過")).toBeInTheDocument();
    },
};
