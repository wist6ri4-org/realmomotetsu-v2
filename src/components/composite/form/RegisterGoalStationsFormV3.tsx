...
/**
 * RegisterGoalStationsFormV3コンポーネントのプロパティ型定義
 ...
 */
interface RegisterGoalStationsFormV3Props {
    stations: Stations[];
    event: Events;
    onSubmit?: () => void;
    isOperating: boolean;
...
/**
 * 目的駅登録フォームコンポーネント
 * @param {RegisterGoalStationsFormV3Props} props - RegisterGoalStationsFormV3のプロパティ
 * @returns {JSX.Element} - RegisterGoalStationsFormV3コンポーネント
 */
const RegisterGoalStationsFormV3: React.FC<RegisterGoalStationsFormV3Props> = ({
    stations,
    event,
    onSubmit,
    isOperating,
}: RegisterGoalStationsFormV3Props): React.JSX.Element => {
...
export default RegisterGoalStationsFormV3;
