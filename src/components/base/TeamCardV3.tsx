...
/**
 * TeamCardV3コンポーネント
 * @param {TeamCardV3Props} props - TeamCardV3のプロパティ
 * @returns {JSX.Element} - TeamCardV3コンポーネント
 */
export const TeamCardV3: React.FC<TeamCardV3Props> = ({
    teamData,
    bombiiTeamData,
    onClick,
}: TeamCardV3Props): React.JSX.Element => {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <Grid size={8}>
                                <Typography variant="body2" textAlign={"right"}>
                                    {Converter.convertPointsToYenV3(teamData.scoredPoints)}
                                </Typography>
                            </Grid>
                        </Grid>
                        ...
                        >
                            <Apartment sx={{ marginInlineEnd: 1 }} />
                            <Typography variant="body2" component={"span"}>
                                {Converter.convertPointsToYenV3(-1 * teamData.propertyPurchasePoints)}
                            </Typography>
                        </Box>
