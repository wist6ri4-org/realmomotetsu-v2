...
const UserSettingsPage = (): React.JSX.Element => {
    ...
    // 認証ガード
    const { sbUser, user, isLoading: isAuthLoading } = useAuthGuard();
    ...
    const settingsMenuItems: SettingsMenuItem[] = [
        {
            ...
            color: "#4CAF50",
            onClick: () => {
                router.push(`/events/v02/${eventCode}/operation/user-settings/profile`);
            },
        },
        {
            title: "パスワード変更",
            ...
            color: "#F44336",
            onClick: () => {
                router.push(`/events/v02/${eventCode}/operation/user-settings/change-password`);
            },
        },
        {
            title: "アイコン設定",
            ...
            color: "#2196F3",
            onClick: () => {
                router.push(`/events/v02/${eventCode}/operation/user-settings/icon`);
            },
        },
    ];
    ...
    return (
        <>
            <Box>
                <PageTitle
                    title="ユーザー設定"
                    icon={<AccountCircleIcon sx={{ fontSize: "3.5rem", marginRight: 1 }} />}
                />
            </Box>
