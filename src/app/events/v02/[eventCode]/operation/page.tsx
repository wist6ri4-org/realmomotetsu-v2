    ...
    const menuItems = [
        {
            ...
            color: "#4CAF50",
            onClick: () => {
                router.push(`/events/v02/${eventCode}/operation/user-settings`);
            },
        },
        {
            title: "配布資料",
            ...
            color: "#FF9800",
            onClick: () => {
                router.push(`/events/v02/${eventCode}/operation/docs`);
            },
        },
        ...(isAdminUser
            ? [
                {
                    ...
                    color: "#2196F3",
                    onClick: () => {
                        router.push(`/events/v02/${eventCode}/operation/tools`);
                    },
                },
            ]
            : []),
